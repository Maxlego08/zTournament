package fr.maxlego08.ztournament.inventory;
...
import fr.maxlego08.ztournament.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected ZTournamentPlugin plugin;
	...
	protected InventoryResult preOpenInventory(ZTournamentPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ZTournamentPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;

	protected abstract void onClose(InventoryCloseEvent event, ZTournamentPlugin plugin, Player player);

	protected abstract void onDrag(InventoryDragEvent event, ZTournamentPlugin plugin, Player player);
